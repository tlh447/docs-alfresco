...
You can use the Process Services setup wizard to upgrade to the 2.0 version. The process is similar to [installing for the first time]({% link process-services/2.0/install/manual.md %}#install-using-setup-wizards).

Follow these steps to upgrade:

1. Double-click the Process Services setup wizard.
2. Follow the instructions to install the 2.0 version of Process Services.
